...
export default function Home() {
  ...
  return (
    ...
    <section className="lg:flex lg:max-h-screen lg:h-screen ">
      <div className="w-full lg:w-1/4 px-2 lg:px-10 lg:h-screen h-full lg:overflow-hidden bg-slate-600 border lg:border-none pb-2" id="timeline">
        ...
        <div className={`h-full mt-10 lg:mt-20 hidden lg:block`} id="navbar">
      ...
      <div className="w-full lg:w-3/4 py-5 lg:py-0 bg-white px-0 lg:px-10 h-full lg:overflow-y-auto dark:bg-dark">
      
        {/* STEP 1 */}
        <div className={`${active == 1 ? "block":"hidden"} flex items-center justify-center h-full px-5 lg:px-20 2xl:px-44`}>
          <article>
        ...
        {/* STEP 2 */}
        <div className={`${active == 2 ? "block":"hidden"} flex items-center justify-center h-full px-5 lg:px-20 2xl:px-44`}>
          <article>
        ...
        {/* STEP 3 */}
        <div className={`${active == 3 ? "block":"hidden"} flex items-center justify-center h-full px-5 lg:px-20 2xl:px-44`}>
          <article className="block w-full">
            ...
            <form onSubmit={(e) => handlerSubmit(e, true)} className="space-y-2 2xl:space-y-4 h-full 2xl:h-full overflow-y-auto">
              ...
              {/* Alamat */}
              <div className="relative">
                <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{t("form.1.text")}</label>
                <textarea id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 rounded-lg border-2 dark:text-white border-gray-300 focus:outline-none peer" placeholder={t("form.1.placeholder")} required>
                </textarea>
              ...
              <div className="flex items-center gap-2">
                <div className="relative border-2 border-gray-300 rounded-lg py-2 w-1/3">
                  ...
                  >
                    {tempat ?
                    tempat.map((item, id) => {
                      return <Option key={id} value={item.id}>{item.nama}</Option>
                    })
                    :""}
                  </Select>
                ...
                <div className="relative border-2 border-gray-300 rounded-lg py-2 w-2/3">
                  <DatePicker onChange={onChange} bordered={false} className="w-full peer dark:text-white" allowClear={true} placeholder={t("form.4.placeholder")}/>
              ...
              {/* Pekerjaan */}
              <div className="relative border-2 rounded-lg border-gray-300">
                  <input type="text" id="pekerjaan" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer placeholder:text-transparent placeholder:focus:text-gray-500" placeholder={t("form.5.placeholder")} required />
              ...
              <div className="flex items-center justify-center gap-2">
                <div className="relative border-2 rounded-lg border-gray-300 w-1/2">
                    <input type="text" id="hp" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer placeholder:text-transparent placeholder:focus:text-gray-500" placeholder={t("form.6.placeholder")} required />
                ...
                <div className="relative border-2 rounded-lg border-gray-300 w-1/2">
                    <input type="email" id="email" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer placeholder:text-transparent placeholder:focus:text-gray-500" placeholder={t("form.7.placeholder")} required />
              ...
              <div className="flex items-center justify-center gap-2">
                <div className="relative border-2 rounded-lg border-gray-300 w-1/2">
                    <input type="text" id="namaibu" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer placeholder:text-transparent placeholder:focus:text-gray-500" placeholder={t("form.8.placeholder")} required />
                ...
                <div className="relative border-2 rounded-lg border-gray-300 w-1/2">
                    <input type="text" id="sumber" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer placeholder:text-transparent placeholder:focus:text-gray-500" placeholder={t("form.9.placeholder")} required />
              ...
              {/* Alamat */}
              <div className="relative">
                <label htmlFor="alamatlengkap" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{t("form.10.text")}</label>
                <textarea id="alamatlengkap" rows="4" className="block p-2.5 w-full text-sm text-gray-900 rounded-lg border-2 dark:text-white border-gray-300 focus:outline-none peer" placeholder={t("form.10.placeholder")} required>
                </textarea>
        ...
        {/* STEP 4 */}
        <div className={`${active == 4 ? "block":"hidden"} flex items-center justify-center h-full px-5 lg:px-20 2xl:px-44`}>
          <article>
            <h1 className="title">{t("judulpembayaran")}</h1>
            <form onSubmit={(e) => handlerSubmit(e, cek?true:false)}>
              <div className="flex items-center justify-center gap-y-2 flex-wrap">
                <div className="relative border-2 rounded-lg border-gray-300 lg:w-1/3 w-1/2">
                    <input type="number" id="norekening" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer placeholder:text-transparent placeholder:focus:text-gray-500" placeholder={t("form.11.placeholder")} required />
                ...
                <div className="relative border-2 rounded-lg border-gray-300 lg:w-1/3 w-1/2">
                    <input type="text" id="namarekening" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer placeholder:text-transparent placeholder:focus:text-gray-500" placeholder={t("form.12.placeholder")} required />
